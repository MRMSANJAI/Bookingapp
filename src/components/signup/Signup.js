     ...
     <div className='content-container'>
        ...
        <div className='signup-content'>
           ...
           <div className='signupform-con'>
            ...
            <input type='text' className='last-cont' onChange={(event)=>{
                setLastName(event.target.value);
              }}/>
              <p className='firstname'>Email</p>
            <input type='email' className='first-cont' onChange={(event)=>{
                setRegisterEmail(event.target.value);
              }}/>
            <span className='phonenumber'>Phone Number</span>
            <input type='number' className='phone-cont' onChange={(event)=>{
                setPhoneNumber(event.target.value);
              }}/>
            <p className='password'> Create Password</p>
            <input type='password'className='cpassword'onChange={(event)=>{
